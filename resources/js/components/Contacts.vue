<template>
    ...
    <ul class= "list-group">
        <li class="list-group-item" v-for="contact in list">
            ...
            <button @click="showContact(contact.id)" class ="btn btn-default float-right ">Edit</button>
            <button @click="deleteContact(contact.id)" class ="btn btn-danger float-right">Delete</button>
        </li>
    </ul>
    </div>
</template>
...
export default {
    ...
    mounted:function(){
        console.log('contact Componet Loaded');
        this.fetchContactList();
    },
    methods:{
        fetchContactList:function(){
            console.log('Fecthing contact');
